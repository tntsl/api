...
public class RSACoder {
    ...
    public static String decryptByPrivateKey(String data, String key) throws NoSuchPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, InvalidKeySpecException {
        byte[] bytes = decryptByPrivateKey(decryptBASE64(data), key);
     ...
     * @throws Exception
     */
    public static byte[] encryptByPublicKey(String data, String key) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        // 对公钥解密
        byte[] keyBytes = decryptBASE64(key);
        // 取得公钥
